#!/bin/bash
#This script is done to use the last successfull snapshot build of Nuxeo
...
NUXEO_DEMO_DIR=${NUXEO_DEMO_DIR:-nuxeo_dam_demo}
...
wget -O 99-initScriptVariables.sh "https://raw.github.com/nuxeo/presales-vmdemo/master/DemoUpdateScripts/99-initScriptVariablesDAM.sh" --no-check-certificate || exit 1
