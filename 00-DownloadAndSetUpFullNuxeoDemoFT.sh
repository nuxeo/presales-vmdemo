...
NUXEO_DEMO_DIR=${NUXEO_DEMO_DIR:-nuxeo_FT_demo}
...
wget -O 99-initScriptVariables.sh "https://raw.github.com/nuxeo/presales-vmdemo/master/DemoUpdateScripts/99-initScriptVariablesFT.sh" --no-check-certificate || exit 1
